...
public class CheckEligibleRequest {
	...
	public boolean isRequestDataCorrect() {
		...
		LOGGER.error("MyCard check isEligible 签名错误. 计算签名使用的字符串[" + strToComputeSign + "] 请求数据 " + Json.toJson(this));
		return false;
	}
	
	public String getStrToComputeSign() {
