...
@Getter
@Setter
public class MyCardApiPayment extends Payment {
	...
	public boolean isPaymentDataVerified() {
		String strToComputeSign = this.getStrToComputeSign();
	...
	private String getStrToComputeSign() {
		...
		buf.append(MyCardSdk.instance().getAuthKeyMyCard());
		...
		buf.append(MyCardSdk.instance().getAuthKeyCP());
