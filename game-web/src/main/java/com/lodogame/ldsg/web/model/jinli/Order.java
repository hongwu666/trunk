...
import com.lodogame.ldsg.web.util.jinli.SubmitTimeUtil;
...
public class Order {
	 ...
	 *            的形式定义url) [可选]
	 */
	public Order(String outOrderNo, String playerId, String subject, String apiKey, BigDecimal totalFee, BigDecimal dealPrice, String submitTime, Timestamp expireTime, String notifyURL) {
	...
	public String toString() {
		return "Order [outOrderNo=" + outOrderNo + ", playerId=" + playerId + ", subject=" + subject + ", apiKey=" + apiKey + ", totalFee=" + totalFee + ", dealPrice=" + dealPrice + ", submitTime="
				+ submitTime + ", expireTime=" + expireTime + ", notifyURL=" + notifyURL + "]";
	}
