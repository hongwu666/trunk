...
public class AnZhiServiceImpl extends BasePartnerService {
	private static final Logger logger = Logger.getLogger(AnZhiServiceImpl.class);
	...
	public UserToken login(String token, String ext, String partnerId, String serverId, long timestamp, String sign, Map<String, String> params) {
		...
		try {
			...
			if (AnZhiSdk.instance().verifySession(token, uid, timestamp)) {
