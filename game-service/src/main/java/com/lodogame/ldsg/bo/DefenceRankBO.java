...
@Compress
public class DefenceRankBO extends BaseRankBO implements Serializable, Comparable<DefenceRankBO> {
	/**
	 * 
	 */
	...
	@Override
	public int compareTo(DefenceRankBO o) {
		return defenceValue - o.getDefenceValue();
	}
