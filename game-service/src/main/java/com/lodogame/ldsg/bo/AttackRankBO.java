...
@Compress
public class AttackRankBO extends BaseRankBO implements Serializable, Comparable<AttackRankBO> {
	/**
	 * 
	 */
	...
	@Override
	public int compareTo(AttackRankBO o) {
		return attackValue - o.getAttackValue();
	}
