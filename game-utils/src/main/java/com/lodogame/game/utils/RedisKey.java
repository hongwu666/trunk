...
public class RedisKey {
	...
	private final static String prefix = "lg_local";
	 ...
	 * @return
	 */
	public static String getUserEquipRefineListCacheKey(String userId) {
		return prefix + "_" + "user_equip_refine_list_cache_" + userId;
	}

	public static String getUserEquipEnchantListCacheKey(String userId) {
		return prefix + "_" + "user_equip_enchant_list_cache_" + userId;
	}
	 ...
	 * @return
	 */
	public static String getUserStoneListCacheKey(String userId) {
		return prefix + "_" + "user_stone_list_cache_" + userId;
	}
	...
	public static String getUserArenaRankKey() {
		return prefix + "_" + "user_arena_rank_key";
	}

	public static String getUserFriendCacheKey(String uid) {
		return prefix + "_" + "user_friend_key_" + uid;
	}

	public static String getUserFriendRequestKey(String userId) {
		return prefix + "_" + "user_friend_request_key_" + userId;
	}
	 ...
	 * @return
	 */
	public static String getUserPowerCacheKey() {
		return prefix + "_" + "user_power_cache_key";
	}
	 ...
	 * @return
	 */
	public static String getHeroPowerCacheKey() {
		return prefix + "_" + "hero_power_cache_key";
	}

	/**
	 * 点赞
	 */
	public static String getUserPraiseCacheKey(String userId) {
		return prefix + "_" + "user_praise_cache_key_" + userId;
	}

	public static String getUserMonthlyCardCacheKey() {
		return prefix + "_" + "user_monthly_card_key";
	}

	public static void main(String[] args) {
		System.out.println(getUserExtinfoCacheKeyPreFix());
	}

	public static String getUserLoginLogCacheKey() {
		return prefix + "_" + "user_login_log_cache_key";
	}

	public static String getTreasureCacheKey(String userId) {
		return prefix + "_" + "user_treasuer_cache_key_" + userId;
	}

	public static String getUserForcesResetTimeKey(String userId, String date) {
		return prefix + "_" + "user_forces_reset_times_cache_key_" + userId + "_" + date;
	}
}
